    ...
    return (
        <div className="shadow-md">
            <ul className=" nav flex justify-end   text-white bg-gray-800 px-6 pt-8 space-x-14 pb-6 pl-20 text-1xl items-center font-serif  cb:text-base">
                ...
                <li className="resume rounded text-center py-2 px-3 bg-lime-600 hover:bg-green-900 text-white"><a href="https://drive.google.com/uc?export=download&id=1e9RwqW973jFnXwJQF6qKFSCEBUUE00gA">Resume</a></li>
            </ul>
        </div>
    );
}
